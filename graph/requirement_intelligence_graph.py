...
builder.add_node("enrich_requirement_analysis", enrich_requirement_analysis)
...
builder.add_edge("analyze_requirement", "enrich_requirement_analysis")
builder.add_edge("enrich_requirement_analysis", "generate_clarifications")
builder.add_edge("generate_clarifications", "generate_requirement_summary")
builder.add_edge("generate_requirement_summary", "generate_test_scope")
builder.add_edge("generate_test_scope", END)

requirement_intelligence_graph = builder.compile()