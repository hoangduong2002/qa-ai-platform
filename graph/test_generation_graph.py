...
builder.add_node("build_coverage_model", build_coverage_model)
...
builder.add_edge("generate_test_scope", "build_coverage_model")
builder.add_edge("build_coverage_model", "generate_scenarios")
